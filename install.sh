...
cp "$ROOT_DIR/scripts/designmd.mjs" "$DIST_DIR/scripts/designmd.mjs"
...
mkdir -p "$DIST_DIR/docs/designmd-examples"
cp "$ROOT_DIR/docs/designmd-workflows.md" "$DIST_DIR/docs/designmd-workflows.md"
cp -R "$ROOT_DIR/docs/designmd-examples/." "$DIST_DIR/docs/designmd-examples/"
